    ...
    <main className="listing-detail-shell">
      <div className="listing-detail">
        ...
        <section className="listing-photo-gallery" aria-label="Property photos">
          ...
          <a className="show-all-photos" href={listing.images[0]} target="_blank" rel="noopener noreferrer">
            Show all photos
          </a>
        </section>
        ...
        <div className="listing-main-layout">
          <article className="listing-content">
              ...
              <div>
                {Array.from({ length: Math.min(Math.max(listing.bedrooms, 1), 2) }).map(
                  (_, index) => (
                    <article key={index}>
                      <a
                        href={listing.images[(index + 1) % listing.images.length]}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <Image
            ...
            <section className="detail-amenities">
              ...
              <button>Show all {listing.amenities.length} amenities</button>
            </section>

            <AvailabilityCalendar city={listing.city} unavailablePeriods={listing.unavailable_dates} />
            ...
            <section className="detail-reviews">
              ...
              <button>Show all {listing.review_count} reviews</button>
            </section>
