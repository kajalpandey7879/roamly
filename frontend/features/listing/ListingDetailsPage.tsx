...
function amenityIcon(name: string) {
  ...
  if (amenity.includes('pool') || amenity.includes('ocean') || amenity.includes('lake'))
    return Waves;
...
function amenityDescription(name: string) {
  ...
  if (amenity.includes('air conditioning'))
    return 'Climate control is available in the main rooms.';
...
function Page() {
  ...
  if (loadError) {
    return (
      <main className="listing-detail-shell detail-empty-state">
        <House size={38} />
        <h1>This home is unavailable</h1>
        <p>It may have been removed, or the listing link may be incorrect.</p>
        <Link href="/">Explore other homes</Link>
      </main>
    );
  }
  ...
  const visibleReviews: Review[] = listing.reviews ?? [];
            ...
            <article className="listing-content">
              ...
              <section className="listing-description">
                ...
                <p>
                  ...
                  restaurants, neighbourhood favourites, and the area&apos;s main attractions are
                  within easy reach.
                </p>
              ...
              <section className="detail-reviews">
                ...
                <p className="review-summary">
                  {listing.review_count
                    ? 'Ratings and comments below come from verified stays.'
                    : 'Be the first guest to review this home after a completed stay.'}
                </p>
                <div>
            ...
            <section className="meet-host">
              ...
              <div className="host-profile-layout">
                ...
                <div className="host-profile-copy">
                  ...
                  <button onClick={() => toast.success('Messaging is coming soon')}>
                    Message host
                  </button>
                  <small>
                    <ShieldCheck size={15} /> To protect your payment, always use Roamly to send
...
function ListingDetailSkeleton() {
  return (
    <main className="listing-detail-shell" aria-label="Loading listing details">
      <div className="listing-detail detail-skeleton">
